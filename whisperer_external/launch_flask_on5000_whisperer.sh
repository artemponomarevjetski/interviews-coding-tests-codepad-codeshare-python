...
MODE="HEADPHONE"  # Changed mode identifier
...
{
  echo
  log "Starting HEADPHONE Conversation Transcription Service"
  echo "====================================================="
  ...
  echo
  echo "Starting HEADPHONE transcription service on http://localhost:${PORT} …"
  echo "MODE: Listening through headphones/earphones"
  echo "Ensure headphones are connected and microphone is enabled"
